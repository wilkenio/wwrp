...
<head>
    ...
    <title>Editar Produto | WWRPR Esportes | </title>
...
if (!isset($_SESSION['adm'])) {
    ...
    <form action="../backend/editarProduto.php" method="post" enctype="multipart/form-data">
        ...
        <p>Valor:</p>
        <input type="number" name="valor" placeholder="Valor"  step="0.01" value="<?php echo $valor; ?>" required>
    ...
    <script>
        function alterouImagem(){
            ...
            document.getElementById('upload-edit-file').innerText="Arquivo Carregado";
        }
    </script>
</body>
</html>
