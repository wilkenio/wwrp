...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['payment_id'])) {
    ...
    try {
        // Consulta na tabela pagamentos para obter o status atual do pagamento
        ...
        if ($stmt->rowCount() > 0) {
            ...
            // Verifica se o status atual é diferente do novo status para atualizar no banco de dados
